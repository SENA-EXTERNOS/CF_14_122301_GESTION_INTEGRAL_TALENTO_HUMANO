    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo.color-acento-contenido
          h2 Elaboración del manual de funciones
        p.mb-4  Esta actividad le permitirá determinar el grado de apropiación de los contenidos del componente formativo.
        p.mt-2  De acuerdo con la definición planteada en la columna izquierda, arrastre cada término al lugar que considere correcto de la columna derecha.
